...
public class PostFactory {
    ...
    public static PostPreviewResponse createMockPostPreviewResponse() {
        return PostPreviewResponse.builder()
                .postId(1L)
                .title("계절학기 중간고사 일주일도 안남았네;")
                .previewContent("생각보다 빡세네 다음부턴 계절학기 안해야겠다")
                .thumbnailPhotoUrl("https://issac-dev.s3.ap-northeast-2.amazonaws.com/images/post/2025/01/08/5495e732-47d2-4edf-a216-a6885aecf438")
                .author(createMockUserInfoResponse())
                .likeCount(2L)
                .commentCount(4L)
    ...
    public static List<PostPreviewResponse> createMockPostPreviewResponses() {
        return Arrays.asList(createMockPostPreviewResponse(), createMockPostPreviewResponse());
    }
